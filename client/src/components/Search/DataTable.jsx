...
export default function DataTable({
  ...
  return (
    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
      <div className="overflow-x-auto">
        <DndContext collisionDetection={closestCenter} onDragEnd={handleDragEnd}>
          <table className="w-full text-sm">
            <thead>
              <tr>
                <th className="px-3 py-2 bg-slate-50 border-b border-slate-200 w-10">
                  <input
                    type="checkbox"
              ...
              {/* 列筛选行 */}
              <tr>
                <th className="px-3 py-1 bg-slate-50 border-b border-slate-200" />
                {allColumns.map((col) => (
      ...
      <div className="px-4 py-2 bg-slate-50 text-xs text-slate-500 border-t border-slate-200 flex justify-between">
